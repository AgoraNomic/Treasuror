# FORBES FOUR HUNDRED NINETY-ONE
*or* TREASUROR'S WEEKLY REPORT

* **Date of last official report:** 28 June 2020
* **Date of this report:** 06 July 2020
...
* FORMATTING:
  * This report uses a new asset abbreviation format. All abbreviatons
    are now two characters. It should be much easier to parse.
  * To cut down on bulk, I have removed the history from the month of
    February. I plan on generally deleting the fifth most recent month
    each time we enter a new month, leading to a history about one
    quarter of a year.
* ASSUMPTIONS:
  * This report assumes that the number of parties to The Plunder
    Partnership was ten at the time that 500 coins were transferred to
    it (as affirmed by the H. Notary ATMunn) and fixes the balances of
    those players who already tranferred 71 coins to themselves in
    exchange for doubloons.
  * This report assumes that R. Lee's transfers to G. and the Dragon
    QuickExchange after previously transferring eir assets to Publius
    Scribonius Scholasticus were INEFFECTIVE.
* OTHER:
  * A payday has occured since the previous report. Please check that
    you recieved the correct amount of coins.
...
|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
|Aris        | 757|   0|   0|   0|   0|   3|   3|   4|   2|
|ATMunn      | 162|   1|   0|   0|   1|   0|   0|   1|   0|
|Baron[1]    | 120|   1|   1|   1|   1|   0|   0|   0|   0|
|Cuddlebeam  |  14|   0|   0|   0|   0|   0|   0|   0|   0|
|D. Margaux  |1264|   1|   1|   1|   1|   0|   0|   0|   0|
|Falsifian   | 298|   0|   2|   1|   0|   0|   2|   0|   0|
|Fred        |  10|   1|   1|   1|   1|   0|   0|   0|   0|
|G.          |1066|   1|   1|   0|   1|   0|   0|  10|   0|
|Gaelan      |  63|   1|   1|   1|   1|   0|   0|   0|   0|
|grok        |  43|   1|   1|   1|   1|   0|   0|   0|   0|
|Jason       | 707|   0|   1|   0|   0|   1|   3|   4|   0|
|Murphy      | 278|   1|   1|   1|   1|   0|   0|   0|   0|
|omd         | 293|   1|   1|   1|   1|   0|   0|   0|   0|
|nch         | 141|   1|   1|   0|   3|   0|   0|   2|   4|
|Publius[2]  | 266|   2|   0|   3|   1|   0|   1|   0|   3|
|R. Lee      | 159|   0|   0|   0|   0|   0|   0|   0|   0|
|sukil       |  40|   1|   1|   1|   1|   0|   0|   0|   0|
|Telnaior    |   5|   0|   0|   0|   0|   0|   0|   0|   0|
|Trigon      | 141|   1|   1|   1|   1|   0|   0|   0|   0|
...
|L&F Dept.[3]| 125|   0|   0|   0|   0|   0|   0|   0|   0|
|NAX         |  28|   0|   0|   0|   0|   0|   0|   0|   0|
|PlunderPS[4]| 150|   0|   0|   0|   0|   0|   0|   0|   0|
...
|          |       |28 Jun 2020 01:48|   LAST WEEKLY REPORT            |
